...
<tiles:initContainer containerFactory="org.apache.tiles.factory.TilesContainerFactory">
    <tiles:putAttribute name="definitions-config"
               value="/WEB-INF/tiles-defs.xml,/WEB-INF/freemarker/tiles-defs.xml,/org/apache/tiles/classpath-defs.xml,/org/apache/tiles/freemarker-classpath-defs.xml,/WEB-INF/tiles-defs-1.1.xml,/WEB-INF/freemarker/tiles-defs-1.1.xml"/>
    ...
    <tiles:putAttribute name="org.apache.tiles.context.ChainedTilesRequestContextFactory.FACTORY_CLASS_NAMES"
               value="org.apache.tiles.servlet.context.ServletTilesRequestContextFactory,org.apache.tiles.jsp.context.JspTilesRequestContextFactory,org.apache.tiles.freemarker.context.FreeMarkerTilesRequestContextFactory"/>
</tiles:initContainer>
