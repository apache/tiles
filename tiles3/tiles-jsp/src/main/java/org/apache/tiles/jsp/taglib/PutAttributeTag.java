 ...
 * <li>beanName : Name of a bean used for setting value. Only valid if value is
 * not set. If property is specified, value come from bean's property.
 ...
 * @version $Rev$ $Date$
 */
public class PutAttributeTag extends BodyTag {
